...
import { updatePrenotazioneVisitaFull } from "@/lib/gestore/infopoint";
...
export function PrenotazioneEditDialog({ prenotazione, attrazioneId }: Props) {
...
function Modal({
  ...
  function save() {
    startTransition(async () => {
      const r = await updatePrenotazioneVisitaFull(
        prenotazione.id,
        attrazioneId,
        {
          stato,
      ...
      <div className="w-full max-w-2xl space-y-4 rounded-2xl border border-border bg-card p-5 shadow-xl">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="space-y-1.5 sm:col-span-2">
            ...
            <Input
              ...
              onChange={(e) => setNumPartecipanti(Number(e.target.value))}
            />
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 border-t border-border pt-3">
          <ComunicazioneButton
            ...
            riferimento={prenotazione.visitaTitolo ?? undefined}
