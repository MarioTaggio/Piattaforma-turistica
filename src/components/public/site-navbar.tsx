...
export async function SiteNavbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-border bg-white lg:bg-background/95 lg:backdrop-blur lg:supports-[backdrop-filter]:bg-background/80">
